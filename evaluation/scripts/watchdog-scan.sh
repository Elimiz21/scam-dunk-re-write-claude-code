...
RESULTS_FILE="/home/user/scam-dunk-re-write-claude-code/evaluation/results/fmp-results-2026-01-15.json"
ALERT_FILE="/tmp/scan-alerts.log"

export FMP_API_KEY="9XxAhEnup4Fw7bvCmEant00kHojNer1s"

echo "[$(date)] Watchdog started" >> $ALERT_FILE
