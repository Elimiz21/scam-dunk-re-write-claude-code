...
export default function AdminMediaEditorPage() {
  ...
  async function handleSave(publish: boolean = false) {
    ...
    try {
      ...
      const url = isNew
        ...
        : `/api/admin/news/media/${params.id}`;
  ...
  async function handleDelete() {
    if (
      !confirm(
        "Are you sure you want to delete this mention? This cannot be undone.",
      )
    ) {
      return;
    }
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                {isNew
                  ? "Add a new media mention"
                  : "Update media mention details"}
              </p>
            </div>
          </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    value={mention.title}
                    onChange={(e) =>
                      setMention({ ...mention, title: e.target.value })
                    }
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setMention({ ...mention, source: e.target.value })
                      }
                      className="w-full px-4 py-2 border border-border rounded-2xl bg-card text-foreground placeholder:text-muted-foreground focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setMention({ ...mention, sourceType: e.target.value })
                      }
                      className="w-full px-4 py-2 border border-border rounded-2xl bg-card text-foreground placeholder:text-muted-foreground focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                    >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setMention({ ...mention, sourceUrl: e.target.value })
                    }
                    className="w-full px-4 py-2 border border-border rounded-2xl bg-card text-foreground placeholder:text-muted-foreground focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setMention({ ...mention, description: e.target.value })
                    }
                    rows={3}
                    className="w-full px-4 py-2 border border-border rounded-2xl bg-card text-foreground placeholder:text-muted-foreground focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setMention({ ...mention, quoteText: e.target.value })
                    }
                    rows={2}
                    className="w-full px-4 py-2 border border-border rounded-2xl bg-card text-foreground placeholder:text-muted-foreground focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
            ...
            <div className="bg-card rounded-2xl shadow p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={() =>
                      setMention({
                        ...mention,
                        isPublished: !mention.isPublished,
                      })
                    }
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                      mention.isPublished ? "bg-purple-600" : "bg-secondary"
                    }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                        mention.isPublished ? "translate-x-6" : "translate-x-1"
                      }`}
                    />
                  </button>
                </div>
                <div className="flex items-center justify-between border-t pt-4">
                  <div className="flex items-center">
                    <Star
                      className={`h-4 w-4 mr-2 ${mention.isFeatured ? "text-yellow-500 fill-yellow-500" : "text-muted-foreground"}`}
                    />
                    <span className="text-sm text-muted-foreground">
                      Featured
                    </span>
                  ...
                  <button
                    onClick={() =>
                      setMention({
                        ...mention,
                        isFeatured: !mention.isFeatured,
                      })
                    }
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                      mention.isFeatured ? "bg-yellow-500" : "bg-secondary"
                    }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                        mention.isFeatured ? "translate-x-6" : "translate-x-1"
                      }`}
                    />
                  </button>
                </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setMention({ ...mention, mentionDate: e.target.value })
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setMention({ ...mention, logoUrl: e.target.value })
                    }
                    className="w-full px-3 py-2 border border-border rounded-2xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-sm"
