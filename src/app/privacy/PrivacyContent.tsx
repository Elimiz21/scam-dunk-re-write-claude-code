        ...
        <main className="flex-1 overflow-y-auto">
          <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            <section className="mb-8 animate-slide-up">
              <div className="p-5 rounded-xl card-elevated">
                <p className="text-sm text-muted-foreground">
                  ScamDunk (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;)
                  is committed to protecting your privacy. This policy explains
                  how we collect, use, disclose, and safeguard your information
                  when you use our stock analysis service.
                </p>
              </div>
            </section>
            ...
            <section className="mb-8 animate-fade-in delay-5">
              ...
              <div className="p-5 rounded-xl card-elevated">
                <ul className="space-y-2 text-sm text-muted-foreground">
                  ...
                  <li>
                    <strong>Scan history:</strong> 12 months
                  </li>
                  <li>
            ...
            <section className="mb-8 animate-fade-in">
              ...
              <div className="p-5 rounded-xl card-elevated text-sm text-muted-foreground">
                <p>
                  ScamDunk is not intended for users under 18. We do not
