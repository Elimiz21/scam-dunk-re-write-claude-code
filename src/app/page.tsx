      ...
      <div className="flex flex-col min-h-screen">
        ...
        <main className="flex-1 flex flex-col">
            ...
            <div className="flex-1 flex items-center justify-center p-4">
              <div className="max-w-lg w-full animate-fade-in">
                <div className="text-center mb-8">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-md bg-primary/8 border border-primary/15 mb-4">
                    <div className="h-1.5 w-1.5 rounded-full bg-primary animate-pulse" />
                    <span className="text-xs font-bold font-mono text-primary uppercase tracking-widest">Scanning</span>
                  </div>
                  <h2 className="text-title mb-1">
                    Analyzing <span className="font-mono gradient-brand-text">{currentTicker.toUpperCase()}</span>
                  </h2>
                  <p className="text-sm text-muted-foreground font-mono">// running multi-layer risk detection</p>
                </div>
          ...
          {!result && !isLoading && !limitReached && (
            <div className="flex-1 flex flex-col items-center justify-center p-4 pb-32 scan-grid">
              <div className="text-center mb-8 max-w-lg mx-auto">
                {/* Icon */}
                <div className="flex justify-center mb-5">
                  <div className="relative">
                    <div className="h-14 w-14 rounded-lg gradient-brand flex items-center justify-center">
                      <Shield className="h-7 w-7 text-primary-foreground" strokeWidth={2} />
                    </div>
                  </div>
                </div>

                {/* Headline */}
                <h1 className="text-hero-sm sm:text-hero mb-3 max-w-xl mx-auto">
                  {tagline.headline}
                </h1>
              ...
              {/* Error message */}
              {error && (
                <div className="mb-6 p-3.5 rounded-lg bg-destructive/8 border border-destructive/20 text-destructive text-sm max-w-md text-center animate-fade-in font-mono">
              ...
              {!session && status !== "loading" && (
                <div className="mb-8">
                  <p className="text-[10px] text-primary/60 text-center mb-3 uppercase tracking-widest font-bold font-mono">
                    // quick scan
                  </p>
              ...
              {!session && status !== "loading" && (
                <div className="grid sm:grid-cols-3 gap-3 max-w-2xl mx-auto mt-4">
                  <div className="p-5 rounded-lg bg-card border border-border text-center hover:border-primary/25 hover:shadow-glow-sm transition-smooth">
                    <div className="h-10 w-10 rounded-md bg-primary/8 border border-primary/15 flex items-center justify-center mx-auto mb-3">
                  ...
                  <div className="p-5 rounded-lg bg-card border border-border text-center hover:border-amber-400/25 hover:shadow-[0_0_20px_-4px_rgba(255,184,0,0.15)] transition-smooth">
                    <div className="h-10 w-10 rounded-md bg-amber-400/8 border border-amber-400/15 flex items-center justify-center mx-auto mb-3">
                  ...
                  <div className="p-5 rounded-lg bg-card border border-border text-center hover:border-emerald-400/25 hover:shadow-[0_0_20px_-4px_rgba(0,255,136,0.15)] transition-smooth">
                    <div className="h-10 w-10 rounded-md bg-emerald-400/8 border border-emerald-400/15 flex items-center justify-center mx-auto mb-3">
