    ...
    <div className="space-y-3">
      ...
      <div className="space-y-2.5">
        {layers.map((layer) => {
          ...
          const status =
            pct === 0 ? "offline" : pct < 50 ? "partial" : "active";
  ...
  const items = [
    {
      ...
      value: aiLayers.layer1_deterministic,
      color: "#6366f1",
      isScore: true,
    },
    {
      label: "L2 Anomaly",
      value: aiLayers.layer2_anomaly,
      color: "#f59e0b",
      isScore: false,
    },
    {
      label: "L3 Random Forest",
      value: aiLayers.layer3_rf,
      color: "#10b981",
      isScore: false,
    },
    {
      label: "L4 LSTM",
      value: aiLayers.layer4_lstm,
      color: "#ec4899",
      isScore: false,
    },
  ];
      ...
      <div className="col-span-2 md:col-span-4 rounded-lg p-2.5 bg-secondary/50 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <span className="text-lg font-bold tabular-nums text-foreground">
            {aiLayers.combined !== null
              ? (aiLayers.combined * 100).toFixed(1) + "%"
              : "—"}
          </span>
