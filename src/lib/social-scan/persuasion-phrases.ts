...
export const PERSUASION_REGEX_PATTERNS: PersuasionRegexPattern[] = [
  ...
  {
    regex:
      /\d{2,4}\s*%\s*(?:in|within|by|over|before)\s+\d+\s*(?:day|week|month|hour)/gi,
  ...
  {
    regex:
      /\b(\d{2,4})x\s*(?:potential|gains?|returns?|from here|your money|guaranteed)/gi,
    principle: "EMOTIONAL_MANIPULATION",
  ...
  {
    regex:
      /only\s+\d+\s*(?:hours?|days?|minutes?|spots?|seats?)\s*(?:left|remaining)/gi,
    principle: "SCARCITY",
  ...
  {
    regex:
      /(?:patreon\.com|buymeacoffee\.com|gumroad\.com|ko-fi\.com|discord\.gg|t\.me|bit\.ly)\/\S+/gi,
...
export const PERSUASION_CATEGORIES: PersuasionCategory[] = [
  {
    ...
    name: "Scarcity",
    description:
      "Creates artificial urgency or limited availability to prevent rational decision-making",
  ...
  },
  {
    ...
    name: "Authority",
    description:
      "Invokes institutional investors, credentials, or expertise to manufacture credibility",
  ...
  },
  {
    ...
    name: "Social Proof",
    description:
      "Claims widespread adoption or community consensus to normalize the behavior",
  ...
  },
  {
    ...
    description:
      "Demonstrates personal commitment to encourage followers to stay consistent",
  ...
  },
  {
    ...
    name: "Liking",
    description:
      "Builds in-group identity and emotional bonds to create trust and compliance",
  ...
  },
  {
    ...
    name: "Call to Action",
    description:
      "Direct commands to buy, subscribe, join, or engage immediately",
  ...
  },
  {
    ...
    name: "Monetization",
    description:
      "Language promoting paid services, courses, subscriptions, or donations",
  ...
  },
  {
    ...
    description:
      "Triggers fear of missing potential gains by referencing past winners or imminent catalysts",
  ...
  },
  {
    ...
    description:
      "Exploits greed, fear, hope, and shame to override rational analysis",
  ...
  },
  {
    ...
    description:
      "Manufactures trust and credibility through track record claims and insider framing",
...
export function analyzePersuasionTechniques(
  ...
  for (const pattern of PERSUASION_REGEX_PATTERNS) {
    ...
    if (pattern.flag === "Multi-ticker mention (check count)" && matches) {
      ...
      if (uniqueTickers >= 6) {
        ...
        flags.push(
          `[CALL_TO_ACTION] Lists ${uniqueTickers} tickers (likely alert spam)`,
        );
      } else if (uniqueTickers >= 4) {
        totalScore += 20;
        principleScores["CALL_TO_ACTION"] += 20;
        flags.push(
          `[CALL_TO_ACTION] Lists ${uniqueTickers} tickers (multi-ticker promotion)`,
        );
      }
    }
  ...
  const distinctPrinciplesUsed = Object.values(principleScores).filter(
    (s) => s > 0,
  ).length;
