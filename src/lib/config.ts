...
export const config = {
  ...
  get aiBackendUrl() {
    return env("AI_BACKEND_URL", "http://localhost:8000");
  },
  get aiApiSecret() {
    return env("AI_API_SECRET");
  },
  ...
  get adminAlertEmail() {
    return env("ADMIN_ALERT_EMAIL");
  },

  // Browser Agent Platform Credentials (personal account logins)
  get browserDiscordEmail() {
    return env("BROWSER_DISCORD_EMAIL");
  },
  get browserDiscordPassword() {
    return env("BROWSER_DISCORD_PASSWORD");
  },
  get browserDiscord2faSecret() {
    return env("BROWSER_DISCORD_2FA_SECRET");
  },
  get browserRedditUsername() {
    return env("BROWSER_REDDIT_USERNAME");
  },
  get browserRedditPassword() {
    return env("BROWSER_REDDIT_PASSWORD");
  },
  get browserReddit2faSecret() {
    return env("BROWSER_REDDIT_2FA_SECRET");
  },
  get browserTwitterUsername() {
    return env("BROWSER_TWITTER_USERNAME");
  },
  get browserTwitterPassword() {
    return env("BROWSER_TWITTER_PASSWORD");
  },
  get browserTwitter2faSecret() {
    return env("BROWSER_TWITTER_2FA_SECRET");
  },
  get browserInstagramUsername() {
    return env("BROWSER_INSTAGRAM_USERNAME");
  },
  get browserInstagramPassword() {
    return env("BROWSER_INSTAGRAM_PASSWORD");
  },
  get browserInstagram2faSecret() {
    return env("BROWSER_INSTAGRAM_2FA_SECRET");
  },
  get browserFacebookEmail() {
    return env("BROWSER_FACEBOOK_EMAIL");
  },
  get browserFacebookPassword() {
    return env("BROWSER_FACEBOOK_PASSWORD");
  },
  get browserFacebook2faSecret() {
    return env("BROWSER_FACEBOOK_2FA_SECRET");
  },
  get browserTiktokUsername() {
    return env("BROWSER_TIKTOK_USERNAME");
  },
  get browserTiktokPassword() {
    return env("BROWSER_TIKTOK_PASSWORD");
  },
  get browserTiktok2faSecret() {
    return env("BROWSER_TIKTOK_2FA_SECRET");
  },
  get browserSessionEncryptionKey() {
    return env("BROWSER_SESSION_ENCRYPTION_KEY");
  },

  // Credential Sync (bootstrap secrets for dashboard → Vercel/GitHub push)
  get vercelApiToken() {
    return env("VERCEL_API_TOKEN");
  },
  get vercelProjectId() {
    return env("VERCEL_PROJECT_ID");
  },
  get vercelTeamId() {
    return env("VERCEL_TEAM_ID");
  },
  get githubSyncPat() {
    return env("GITHUB_SYNC_PAT");
  },
  get githubRepoOwner() {
